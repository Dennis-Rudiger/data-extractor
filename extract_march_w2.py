"""
Extract sales data from March Week 2 PDFs and save to JSON.
...
departments = {
    "ELECTRICALS": "ELECTRICALS WEEK 2 MARCH.pdf",
    "GENERAL HARDWARE": "GENERAL HARDWARE WEEK 2 MARCH.pdf",
    "PAINTS": "PAINTS WEEK 2 MARCH.pdf",
    "PLUMBING": "PLUMBING WEEK 2 MARCH.pdf"
}
...
# Save to JSON
with open("sales_march_w2.json", "w") as f:
    json.dump(march_w2_data, f, indent=2)
print(f"\nData saved to: sales_march_w2.json")
...
print(f"\n{'=' * 60}")
print(f"MARCH WEEK 2 SUMMARY (Mar 9-14, 2026)")
print(f"{'=' * 60}")
