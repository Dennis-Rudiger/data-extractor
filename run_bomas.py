...
def load_data():
    with open('moq_analysis_bomas_feb_apr.json', 'r') as f:
        return json.load(f)
...
class MOQReport:
    def __init__(self, filename='moq_report_bomas_feb_apr.pdf'):
    ...
    def header_footer(self, canvas, doc):
        ...
        canvas.drawString(self.margin, self.page_height - 0.33 * inch,
                          'BOMAS HARDWARE — MOQ REPORT  |  JAN-FEB 2026  |  76 Working Days  |  Formula: 6 × Daily Avg')
...
class MOQReportWord:
    ...
    def __init__(self, filename='moq_report_bomas_feb_apr.docx'):
        self.filename = filename
...
if __name__ == '__main__':
    report = MOQReport('moq_report_bomas_feb_apr.pdf')
    report.generate()

    word_report = MOQReportWord('moq_report_bomas_feb_apr.docx')
