...
======================================
Reads: stock_movement_bomas_q1.json  (from INVENTORY MOVEMENT FEBRUARY.pdf)
...
Outputs:
  ...
  - bomas_average_moq.json (full MOQ analysis for February)
...
with open('stock_movement_bomas_q1.json', 'r') as f:
    q1_data = json.load(f)
...
with open('bomas_average_moq.json', 'w') as f:
    json.dump(analysis, f, indent=2)
print(f"MOQ analysis saved to bomas_average_moq.json")
...
print("\nDone! Now run: py generate_moq_report_bomas.py")
